...
std::unique_ptr<CUDABatchProcessor> createCUDABatch(uint32_t max_seq_size, uint32_t max_window_depth, uint32_t device, size_t avail_mem, int8_t gap, int8_t mismatch, int8_t match, bool cuda_banded_alignment);
...
public:
    ...
    createCUDABatch(uint32_t max_seq_size, uint32_t max_window_depth, uint32_t device, size_t avail_mem, int8_t gap, int8_t mismatch, int8_t match, bool cuda_banded_alignment);
...
protected:
     ...
     */
    CUDABatchProcessor(uint32_t max_seq_size, uint32_t max_window_depth, uint32_t device, size_t avail_mem, int8_t gap, int8_t mismatch, int8_t match, bool cuda_banded_alignment);
